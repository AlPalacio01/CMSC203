...
public class GradeBookTest {
    ...
    public void setUp() {
        ...
        // Example (you may use these values or choose your own):
        // g1 = new GradeBook(5);
        // g1.addScore(50.0);
        // g1.addScore(75.0);
        //
    ...
    public void testAddScoreAndToString() {
    	...
    	assertEquals("80.0 85.0 90.0 95.0 ", g1.toString());
    	assertEquals("92.2 87.7 91.1 ", g2.toString());
    }
    ...
    public void testSum() {
    	...
    	assertEquals(350.0, g1.sum(), 0.0001);
    	assertEquals(271.0, g2.sum(), 0.0001);
    }
    ...
    public void testMinimum() {
    	...
    	assertEquals(80.0, g1.minimum(), 0.0001);
    	assertEquals(87.7, g2.minimum(), 0.0001);
    	...
    	GradeBook empty = new GradeBook(3);
    	assertEquals(0.0, empty.minimum(), 0.0001);
    }
    ...
    public void testFinalScore() {
    	...
    	assertEquals(270.0, g1.finalScore(), 0.0001);
    	assertEquals(183.3, g2.finalScore(), 0.0001);
        //
    	...
    	GradeBook single = new GradeBook(3);
    	single.addScore(100.0);
    	assertEquals(100.0, single.finalScore(), 0.0001);
    }
}
